...
class Predict_Staphylococcus_aureus(torch.nn.Module):
    ...
    def forward(self, X, bio):
        ...
        # enter convolution module (disabled)
        ...
        # concatenate transformer outputs with biological metadata
...
class Predict_Staphylococcus_aureus_essential_ori_coding(torch.nn.Module):
    def __init__(self, params):
        super(Predict_Staphylococcus_aureus_essential_ori_coding, self).__init__()
        ...
        # +6 accounts for bio features
        self.final_fc1 = nn.Linear(params['latent_dim1'] + params['latent_dim2'] + 6, params['fc_hidden1'])
        self.final_fc2 = nn.Linear(params['fc_hidden1'], params['fc_hidden2'])
        self.final_fc3 = nn.Linear(params['fc_hidden2'], 1)
        # self.bio_fc1 = nn.Linear(13, params['fc_hidden1'])
...
class Predict_Staphylococcus_aureus_remove_bio(torch.nn.Module):
    def __init__(self, params):
        super(Predict_Staphylococcus_aureus_remove_bio, self).__init__()
        ...
        # features only (no bio features concatenated)
    ...
    def forward(self, X):
        ...
        # concatenate transformer outputs (no bio metadata)
