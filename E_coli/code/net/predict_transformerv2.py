...
class Predict_transformer_dim_ori(torch.nn.Module):
    def __init__(self,params):
        super(Predict_transformer_dim_ori, self).__init__()
...
class Predict_transformer(torch.nn.Module):
    def __init__(self,params):
        ...
        self.final_fc1 = nn.Linear(params['latent_dim1'] + params['latent_dim2'] + 9,params['fc_hidden1']) # 其中3+3+2+1=9为生物信息的预留位置
        self.final_fc2 = nn.Linear(params['fc_hidden1'],params['fc_hidden2'])
        self.final_fc3 = nn.Linear(params['fc_hidden2'],1)
        # self.bio_fc1 = nn.Linear(13, params['fc_hidden1'])
